...
namespace Project33.Controllers
{
    public class RegistationController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,first_name,last_name,major,course_id,batch_id,phone_number")] registation registation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,first_name,last_name,major,course_id,batch_id,phone_number")] registation registation)
        {
            if (ModelState.IsValid)
            {
